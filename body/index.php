...
<a href="../pengguna/login/login.php" class="bg-white text-primary font-semibold py-2 px-6 rounded-button whitespace-nowrap hover:bg-gray-100 transition">Masuk</a>
<a href="../pengguna/login/logout.php" class="bg-secondary text-white font-semibold py-2 px-6 rounded-button whitespace-nowrap hover:bg-opacity-90 transition">logout</a>
...
<li><a href="../pengguna/events/events.php" class="text-gray-400 hover:text-white transition">Kategori Event</a></li>
