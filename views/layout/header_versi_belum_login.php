            ...
            <div class="hidden md:flex items-center">
                <?php if (isset($_SESSION['nama_lengkap'])): ?>
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="font-medium">Halo, <?php echo htmlspecialchars(explode(' ', $_SESSION['nama_lengkap'])[0]); ?></span>
        ...
        <div id="mobile-menu" class="md:hidden hidden bg-white text-gray-800 shadow-lg absolute w-full">
            <div class="container mx-auto px-4 py-3 flex flex-col space-y-3">
                ...
                <div class="flex space-x-3 py-2 border-t mt-2">
                     <?php if (isset($_SESSION['nama_lengkap'])): ?>
                        <a href="/eventify/Pengguna/Login/logout.php" class="bg-secondary text-white text-center font-semibold py-2 px-6 rounded-button whitespace-nowrap flex-1 hover:bg-opacity-90 transition">Logout</a>
                    <?php else: ?>
